...
# List of disulfide pairs from 1DPX 
ss_bonds = [
    ("/1dpx//A/CYS`76/SG", "/1dpx//A/CYS`94/SG"),
    ("/1dpx//A/CYS`64/SG", "/1dpx//A/CYS`80/SG"),
    ("/1dpx//A/CYS`30/SG", "/1dpx//A/CYS`115/SG"),
    ("/1dpx//A/CYS`6/SG", "/1dpx//A/CYS`127/SG")
]
...
phantom_names = [f"phantom_SS_{i}" for i in range(1, 5)]
